...
public class Creating_a_Professional_Liability_Claim extends BaseClass {
	...
	public void submittingaEEOCForm(String info[]) throws InterruptedException {
		...
		softassert.assertEquals(driver.findElement(By.xpath("//label[text()='Litigation Claim #']")).isDisplayed(),
				true, "Litigation Claim # Label is not provided for New Professional Liability Claim ");
		 ...
		 * extentTest.
		 * pass("Successfully verified Department TextBox for New Professional Liability Claim"
		 * );
		 */
		...
		/*
		 * // Discription Charge WebElement discriptionCharge =
		 * driver.findElement(By.id("DiscriminationCharge_chosen"));
		 * data.handleDropdownByText(explicit, driver, discriptionCharge,
		 * "Age Discrimination");
		 * 
		 * softassert.assertEquals(driver.findElement(By.id(
		 * "DiscriminationCharge_chosen")).isDisplayed(), true,
		 * "Discrimination Charge Dropdown is not provided for New Professional Liability Claim "
		 * ); extentTest.
		 * pass("Successfully verified Discrimination Charge Dropdown for New Professional Liability Claim"
		 * );
		 */
		...
		softassert.assertEquals(driver.findElement(By.xpath("//label[text()='Settlement Reserve']")).isDisplayed(),
				true, "Settlement Reserve Label is not provided for New Professional Liability Claim ");
		 ...
		 * true, "Settlement Reserve Text box is not provided for New Professional Liability Claim ");
		 * extentTest.
		 * pass("Successfully verified Settlement Reserve TextBox for New Professional Liability Claim");
...
//Verifying Title Textbox on Attachment Popup
		...
		softassert.assertEquals(titleTb.isDisplayed(), true,
				"Title Textbox is not provided for attachment popup for Professional Liability Claim");
...
//Deleting an added attachment
		...
		softassert.assertEquals(deleteButton.isDisplayed(), true,
				"Delete button is not provided for attachment popup for Professional Liability Claim");
		...
		Reporter.log("Attachement removed Successfully for Professional Liability Claim" + attachmentInfo, true);
		extentTest.pass("Attachement removed Successfully for Professional Liability Claim" + attachmentInfo);
		...
		softassert.assertEquals(driver.findElement(By.xpath("//label[text()='Invoice Number']")).isDisplayed(), true,
				"Invoice Number Label is not provided for New Professional Liability Claim ");
		extentTest.pass("Successfully verified Invoice Number Label for New Professional Liability Claim");
		...
		extentTest.pass("Successfully Entered Invoice Number Text box for New Professional Liability Claim");
		...
		extentTest.pass("Successfully Entered UnderWriter Text box for New Professional Liability Claim");
		...
		softassert.assertEquals(driver.findElement(By.xpath("//label[text()='Inv.Date Paid']")).isDisplayed(), true,
				"Inv.Date Paid Label is not provided for New Professional Liability Claim ");
		extentTest.pass("Successfully verified Inv.Date Paid Label for New Professional Liability Claim");
		...
		extentTest.pass("Successfully Entered InvDatePaid Text box for New Professional Liability Claim");
		...
		softassert.assertEquals(driver.findElement(By.xpath("//label[text()='Fees']")).isDisplayed(), true,
				"Fees Label is not provided for New Professional Liability Claim ");
		...
		Reporter.log("File Choosen button is provided for Add Expense/Settlement popup for Professional Liability Claim", true);
		extentTest.pass("File Choosen button is provided for Add Expense/Settlement popup for Professional Liability Claim");
		driver.findElement(By.id("file")).sendKeys("C:\\Users\\Admin\\git\\MDR\\MDR\\testData\\IncidentByMonth.Pdf");
...
driver.findElement(By.id("Reserve")).clear();
 ...
 String reserveonUpdatedPage = driver.findElement(By.id("Reserve")).getAttribute("value");
