...
public class Creating_a_General_Liability_Claim extends BaseClass {
	...
	public void submittingaEEOCForm(String info[]) throws InterruptedException {
		...
		// Clicking on New Claim Button on RMS Home Page
				...
				// Clicking on General Liability claim Option
				WebElement EEOCClaim = driver.findElement(By.partialLinkText("General Liability Claim"));
				explicit.until(ExpectedConditions.elementToBeClickable(EEOCClaim));
				softassert.assertEquals(driver.findElement(By.partialLinkText("General Liability Claim")).isDisplayed(), true,
						"General Liability Claim Option is not provided in RMS Home Page");
				driver.findElement(By.partialLinkText("General Liability Claim")).click();
				extentTest.pass("Successfully verified General Liability Claim Option Under New Claim in Left Nav Bar of RMS Home Page");
				...
				softassert.assertEquals(driver.findElement(By.xpath("//label[text()='Name']")).isDisplayed(), true,
						"Name Label is not provided for New General Liability Claim ");
				extentTest.pass("Successfully verified Name Label for New General Liability Claim");
				...
				softassert.assertEquals(driver.findElement(By.id("Claimant")).isDisplayed(), true,
						"Name Text box is not provided for New General Liability Claim ");
				extentTest.pass("Successfully verified Name TextBox for New General Liability Claim");
				...
				softassert.assertEquals(driver.findElement(By.xpath("//label[text()='Date of Incident']")).isDisplayed(), true,
						"Date of Incident Label is not provided for New General Liability Claim ");
				extentTest.pass("Successfully verified Date of Incident Label for New General Liability Claim");
				...
				softassert.assertEquals(driver.findElement(By.id("DateOfIncident")).isDisplayed(), true,
						"Date of Incident Text box is not provided for New General Liability Claim ");
				extentTest.pass("Successfully verified Date of Incident TextBox for New General Liability Claim");
				...
				softassert.assertEquals(driver.findElement(By.xpath("//label[text()='Entered By']")).isDisplayed(), true,
						"Date of Entered By Label is not provided for New General Liability Claim ");
				extentTest.pass("Successfully verified Date of Entered By Label for New General Liability Claim");
				...
				softassert.assertEquals(driver.findElement(By.id("ReportedBy")).isDisplayed(), true,
						"Entered By Text box is not provided for New General Liability Claim ");
				extentTest.pass("Successfully verified Entered By TextBox for New General Liability Claim");
				...
				softassert.assertEquals(driver.findElement(By.xpath("//label[text()='DOB']")).isDisplayed(), true,
						"Date of Birth Label is not provided for New General Liability Claim ");
				extentTest.pass("Successfully verified Date of Birth Label for New General Liability Claim");
				...
				softassert.assertEquals(driver.findElement(By.id("DOB")).isDisplayed(), true,
						"Date of Birth Text box is not provided for New General Liability Claim ");
				extentTest.pass("Successfully verified Date of Birth TextBox for New General Liability Claim");
				
				softassert.assertEquals(driver.findElement(By.id("DOB")).isDisplayed(), true,
						"DOB Text box is not provided for New General Liability Claim ");
				extentTest.pass("Successfully verified DOB TextBox for New General Liability Claim");
				driver.findElement(By.id("DOB")).sendKeys(info[2]);
				
				

				// Verifying EEOC Number Label and TextBox and Entering the data from Excel
				WebElement eeocLabel = driver.findElement(By.xpath("//label[text()='MRN #']"));
				...
				softassert.assertEquals(driver.findElement(By.xpath("//label[text()='MRN #']")).isDisplayed(), true,
						"MRN # Label is not provided for New General Liability Claim ");
				extentTest.pass("Successfully verified MRN # Label for New General Liability Claim");

				WebElement eeocTB = driver.findElement(By.id("MRNNumber"));
				...
				softassert.assertEquals(driver.findElement(By.id("MRNNumber")).isDisplayed(), true,
						"MRN Number Text box is not provided for New General Liability Claim ");
				extentTest.pass("Successfully verified MRN Number TextBox for New General Liability Claim");
				...
				softassert.assertEquals(driver.findElement(By.xpath("//label[text()='Litigation Claim #']")).isDisplayed(),
						true, "Litigation Claim # Label is not provided for New General Liability Claim ");
				extentTest.pass("Successfully verified Litigation Claim # Label for New General Liability Claim");
				...
				softassert.assertEquals(driver.findElement(By.id("LitigationClaimNumber")).isDisplayed(), true,
						"Litigation Claim # Text box is not provided for New General Liability Claim ");
				extentTest.pass("Successfully verified Litigation Claim # TextBox for New General Liability Claim");
				 ...
				 * "EEOC Status Label is not provided for New General Liability Claim ");
				 * extentTest.pass("Successfully verified EEOC Status Label for New General Liability Claim"
				 * );
				 * 
				...
				softassert.assertEquals(driver.findElement(By.xpath("//label[text()='Date Filed']")).isDisplayed(), true,
						"Date Filed Label is not provided for New General Liability Claim ");
				extentTest.pass("Successfully verified Date Filed Label for New General Liability Claim");
				...
				softassert.assertEquals(driver.findElement(By.id("DateFiled")).isDisplayed(), true,
						"Date Filed Text box is not provided for New General Liability Claim ");
				extentTest.pass("Successfully verified Date Filed TextBox for New General Liability Claim");
				...
				softassert.assertEquals(driver.findElement(By.xpath("//label[text()='Date Closed']")).isDisplayed(), true,
						"Date Closed Label is not provided for New General Liability Claim ");
				extentTest.pass("Successfully verified Date Closed Label for New General Liability Claim");
				...
				softassert.assertEquals(driver.findElement(By.id("DateClosed")).isDisplayed(), true,
						"Date Closed Text box is not provided for New General Liability Claim ");
				extentTest.pass("Successfully verified Date Closed TextBox for New General Liability Claim");
				 ...
				 * driver.findElement(By.id("DepartmentId_chosen"));
				 * 
				 ...
				 * "Department Label is not provided for New General Liability Claim ");
				 * extentTest.pass("Successfully verified Department Label for New General Liability Claim");
				 * 
				 ...
				 */
				/*
				 * softassert.assertEquals(driver.findElement(By.id("DepartmentId_chosen")).
				 * isDisplayed(), true,
				 * "Department Text box is not provided for New General Liability Claim ");
				 * extentTest.
				 * pass("Successfully verified Department TextBox for New General Liability Claim"
				 * );
				 */
				...
				softassert.assertEquals(driver.findElement(By.xpath("//label[text()='Attorney']")).isDisplayed(), true,
						"Attorney Label is not provided for New General Liability Claim ");
				extentTest.pass("Successfully verified Attorney Label for New General Liability Claim");
				...
				softassert.assertEquals(driver.findElement(By.id("Attorney")).isDisplayed(), true,
						"Attorney Text box is not provided for New General Liability Claim ");
				extentTest.pass("Successfully verified Attorney TextBox for New General Liability Claim");
				...
				softassert.assertEquals(driver.findElement(By.id("DiscriminationCharge_chosen")).isDisplayed(), true,
						"Discrimination Charge Dropdown is not provided for New General Liability Claim ");
				extentTest.pass("Successfully verified Discrimination Charge Dropdown for New General Liability Claim");
				...
				softassert.assertEquals(driver.findElement(By.xpath("//label[text()='Full Description Report']")).isDisplayed(),
						true, "Full Description Report Label is not provided for New General Liability Claim ");
				extentTest.pass("Successfully verified Full Description Report Label for New General Liability Claim");
				...
				softassert.assertEquals(driver.findElement(By.id("FullDescriptionReport")).isDisplayed(), true,
						"Full Description Report Text box is not provided for New General Liability Claim ");
				extentTest.pass("Successfully verified Full Description Report TextBox for New General Liability Claim");
				...
				softassert.assertEquals(driver.findElement(By.xpath("//label[text()='Settlement Reserve']")).isDisplayed(),
						true, "Settlement Reserve Label is not provided for New General Liability Claim ");
				extentTest.pass("Successfully verified Settlement Reserve Label for New General Liability Claim");
				...
				softassert.assertEquals(driver.findElement(By.id("CompensationReserve")).isDisplayed(), true,
						"Settlement Reserve Text box is not provided for New General Liability Claim ");
				extentTest.pass("Successfully verified Settlement Reserve TextBox for New General Liability Claim");
				...
				softassert.assertEquals(driver.findElement(By.xpath("//label[text()='Expense Reserve']")).isDisplayed(), true,
						"Settlement Reserve Label is not provided for New General Liability Claim ");
				extentTest.pass("Successfully verified Settlement Reserve Label for New General Liability Claim");
				 ...
				 * true, "Settlement Reserve Text box is not provided for New General Liability Claim ");
				 * extentTest.
				 * pass("Successfully verified Settlement Reserve TextBox for New General Liability Claim");
				...
				// Navigating to Claim List and selecting the created General Liability Claim
		...
		//Verifying Title Textbox on Attachment Popup
				...
				softassert.assertEquals(titleTb.isDisplayed(), true,
						"Title Textbox is not provided for attachment popup for General Liability Claim");
				Reporter.log("Title Textbox is provided for attachment popup", true);
				extentTest.pass("Title Textbox is provided for attachment popup for General Liability Claim");
				...
				softassert.assertEquals(fileUpload.isDisplayed(), true,
						"File Choosen button is not provided for attachment popup for General Liability Claim");
				Reporter.log("File Choosen button is provided for attachment popup for General Liability Claim", true);
				extentTest.pass("File Choosen button is provided for attachment popup for General Liability Claim");
		...
		//Verifying Upload button on Attachment Popup
				...
				softassert.assertEquals(uploadButton.isDisplayed(), true,
						"File Upload button is not provided for attachment popup for General Liability Claim");
				Reporter.log("File Upload button is provided for attachment popup for General Liability Claim", true);
				extentTest.pass("File Upload button is provided for attachment popup for General Liability Claim");
				driver.findElement(By.id("Upload")).click();

				Reporter.log("Sucessfully Added a attachment to the General Liability Claim", true);
				extentTest.pass("Sucessfully Added a attachment to the General Liability Claim");
		...
		//Deleting an added attachment
				...
				softassert.assertEquals(arrowButton1.isDisplayed(), true,
						"Attachment button is not provided for General Liability Claim in Claim list page");
				Reporter.log("Verifyed action arrow button for General Liability Claim in Claim list page", true);
				extentTest.info("Verifyed attachment icon button under Actions for General Liability Claim in Claim list page");
				driver.findElement(By.xpath("//a[text()='" + info[0] + "']/../../..//i[@title='Attachments']")).click();
				...
				softassert.assertEquals(deleteButton.isDisplayed(), true,
						"Delete button is not provided for attachment popup for General Liability Claim");
				Reporter.log("Delete button is provided for attachment popup for General Liability Claim", true);
				extentTest.pass("Delete button is provided for attachment popup for General Liability Claim");
				...
				Reporter.log("Attachement removed Successfully for General Liability Claim" + attachmentInfo, true);
				extentTest.pass("Attachement removed Successfully for General Liability Claim" + attachmentInfo);
				...
				extentTest.pass("Successfully Clicked on Add Expense/Settlement button under General Liability Claims Details");
				...
				softassert.assertEquals(driver.findElement(By.xpath("//label[text()='Payment Type']")).isDisplayed(), true,
						"Payment Type Label is not provided for New General Liability Claim ");
				extentTest.pass("Successfully verified Payment Type Label for New General Liability Claim");
				...
				softassert.assertEquals(driver.findElement(By.xpath("//label[text()='Invoice Number']")).isDisplayed(), true,
						"Invoice Number Label is not provided for New General Liability Claim ");
				extentTest.pass("Successfully verified Invoice Number Label for New General Liability Claim");
				...
				extentTest.pass("Successfully Entered Invoice Number Text box for New General Liability Claim");
				...
				extentTest.pass("Successfully Entered UnderWriter Text box for New General Liability Claim");
				...
				softassert.assertEquals(driver.findElement(By.xpath("//label[text()='Inv.Date']")).isDisplayed(), true,
						"Inv.Date Label is not provided for New General Liability Claim ");
				extentTest.pass("Successfully verified Inv.Date Label for New General Liability Claim");
				...
				extentTest.pass("Successfully Entered InvDate Text box for New General Liability Claim");
				...
				softassert.assertEquals(driver.findElement(By.xpath("//label[text()='Inv.Date Paid']")).isDisplayed(), true,
						"Inv.Date Paid Label is not provided for New General Liability Claim ");
				extentTest.pass("Successfully verified Inv.Date Paid Label for New General Liability Claim");
				...
				extentTest.pass("Successfully Entered InvDatePaid Text box for New General Liability Claim");
				...
				softassert.assertEquals(driver.findElement(By.xpath("//label[text()='Fees']")).isDisplayed(), true,
						"Fees Label is not provided for New General Liability Claim ");
				extentTest.pass("Successfully verified Fees Label for New General Liability Claim");

				driver.findElement(By.id("Fees")).sendKeys("20");
				String feesDataonAddPopup = driver.findElement(By.id("Fees")).getAttribute("value");

				extentTest.pass("Successfully Entered Fees Text box for New General Liability Claim");
				...
				softassert.assertEquals(driver.findElement(By.id("file")).isDisplayed(), true,
						"File Choosen button is not provided for Add Expense/Settlement popup for General Liability Claim");
				Reporter.log("File Choosen button is provided for Add Expense/Settlement popup for General Liability Claim", true);
				extentTest.pass("File Choosen button is provided for Add Expense/Settlement popup for General Liability Claim");
				driver.findElement(By.id("file")).sendKeys("C:\\Users\\Admin\\git\\MDR\\MDR\\testData\\IncidentByMonth.Pdf");

				// Clicking on save button
				driver.findElement(By.xpath("(//button[@type='submit'])[2]")).click();

				extentTest.pass("Successfully added a Expense/Settlement for General Liability Claim for General Liability Claim");
				...
				extentTest.pass("Invoice Data is Matched on Edit Expense/Settlement popup for General Liability Claim");
				...
				extentTest.pass("Attorney Data is Matched on Edit Expense/Settlement popup for General Liability Claim");
		...
		//Verifying Inv Date
				...
				extentTest.pass("InvDate Data is Matched on Edit Expense/Settlement popup for General Liability Claim");
		...
		//Verifying Inv.Date Paid
				...
				extentTest.pass("InvDatePaid Data is Matched on Edit Expense/Settlement popup for General Liability Claim");
		...
		//Verifying Fees 
				...
				extentTest.pass("Fees Data is Matched on Edit Expense/Settlement popup for General Liability Claim");
		...
		extentTest.pass("Sucessfully deleted added Manage Expense/Settlement for General Liability Claim");
		...
		extentTest.pass("Successfully verified Inv.Date Label for New General Liability Claim");
		extentTest.pass("Sucessfully Clicked Add Reserve Button for General Liability Claim");
		...
		extentTest.pass("Sucessfully Verified Reserve Type Label in  Add Reserve popup for General Liability Claim");
		...
		extentTest.pass("Sucessfully Verified Date Label in Add Reserve popup for General Liability Claim");
		...
		extentTest.pass("Sucessfully Entered Date Text Box in Add Reserve popup for General Liability Claim");
		...
		extentTest.pass("Sucessfully Verified Reserve Label in Add Reserve popup for General Liability Claim");
		...
		extentTest.pass("Sucessfully Entered Reserve Text Box in Add Reserve popup for General Liability Claim");
		...
		driver.findElement(By.xpath("(//button[@type='submit'])[2]")).click();
		extentTest.pass("Sucessfully Added a Expense/Settlement Reserve for General Liability Claim ");
		...
		extentTest.pass("Sucessfully verified Date data on Edit Reserve Popup for General Liability Claim");

		String reserveonEditReservePopup = driver.findElement(By.id("Reserve")).getAttribute("value");
		softassert.assertEquals(reserveonAddReservePage, reserveonEditReservePopup,"Reserve data is not matching on Edit Reserve Popup for General Liability Claim");

		extentTest.pass("Sucessfully verified Reserve data on Edit Reserve Popup for General Liability Claim");
		...
		driver.findElement(By.id("Reserve")).clear();
		 ...
		 extentTest.pass("Sucessfully Edited Manage Reserve/Settlemetn data on Edit Reserve Popup for General Liability Claim");
		...
		extentTest.pass("Sucessfully deleted added Manage Expense/Settlement Reserve for General Liability Claim");
