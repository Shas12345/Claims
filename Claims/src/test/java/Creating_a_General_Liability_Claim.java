...
public class Creating_a_General_Liability_Claim extends BaseClass {
	...
	public void submittingaEEOCForm(String info[]) throws InterruptedException {
		...
		WebElement nameLabel = driver.findElement(By.xpath("//label[text()='Claimant']"));
		explicit.until(ExpectedConditions.elementToBeClickable(nameLabel));
		softassert.assertEquals(driver.findElement(By.xpath("//label[text()='Claimant']")).isDisplayed(), true,
				"Name Label is not provided for New General Liability Claim ");
		extentTest.pass("Successfully verified Claimant Label for New General Liability Claim");
		...
		softassert.assertEquals(driver.findElement(By.xpath("//label[text()='Litigation Claim #']")).isDisplayed(), true,
				"Litigation Claim # Label is not provided for New General Liability Claim ");
		...
		extentTest.pass("Successfully verified Department TextBox for New General Liability Claim");
...
//Verifying Title Textbox on Attachment Popup
		...
		softassert.assertEquals(titleTb.isDisplayed(), true, "Title Textbox is not provided for attachment popup for General Liability Claim");
...
//Deleting an added attachment
	...
	//	driver.findElement(By.xpath("(//a[contains(text(),'Attachments')])[3]")).click();
		...
		softassert.assertEquals(deleteButton.isDisplayed(), true, "Delete button is not provided for attachment popup for General Liability Claim");
		 ...
		 * Reporter.log("Attachement removed Successfully for General Liability Claim" +
		 * attachmentInfo, true);
		 * extentTest.pass("Attachement removed Successfully for General Liability Claim" +
		 * attachmentInfo);
		 */
	 ...
	 * extentTest.
	 * pass("Successfully Clicked on Expense/Settlement section under General Liability Claims Details"
	 * );
	 * 
	 ...
	 * extentTest.
	 * pass("Successfully Clicked on Add Expense/Settlement button under General Liability Claims Details"
	 * );
	 * driver.findElement(By.xpath("//button[@onclick='addExpenseSettlement(13);']")
	 * ).click();
	 ...
	 * "Invoice Number Label is not provided for New General Liability Claim "); extentTest.
	 * pass("Successfully verified Invoice Number Label for New General Liability Claim");
	 * 
	 * driver.findElement(By.id("InvoiceNumber")).sendKeys("123N123"); extentTest.
	 * pass("Successfully Entered Invoice Number Text box for New General Liability Claim");
	 * 
	 * //UnderWriter
	 * 
	 ...
	 * "UnderWriter Label is not provided for New General Liability Claim ");
	 * extentTest.pass("Successfully verified UnderWriter Label for New General Liability Claim"
	 * );
	 * 
	 * driver.findElement(By.id("Underwriter")).sendKeys("123N123"); extentTest.
	 * pass("Successfully Entered UnderWriter Text box for New General Liability Claim");
	 * 
	 * //Inv.Date
	 * 
	 * WebElement invDate =
	 ...
	 * "Inv.Date Paid Label is not provided for New General Liability Claim "); extentTest.
	 * pass("Successfully verified Inv.Date Paid Label for New General Liability Claim");
	 * 
	 * driver.findElement(By.id("InvPaymentDate")).sendKeys("12/08/2023");
	 * extentTest.
	 * pass("Successfully Entered InvDatePaid Text box for New General Liability Claim");
	 * 
	 ...
	 * ).isDisplayed(), true, "Fees Label is not provided for New General Liability Claim ");
	 ...
	 * ); Reporter.
	 * log("File Choosen button is provided for Add Expense/Settlement popup for General Liability Claim"
	 * , true); extentTest.
	 * pass("File Choosen button is provided for Add Expense/Settlement popup for General Liability Claim"
	 * ); driver.findElement(By.id("file"))
	 * .sendKeys("C:\\Users\\Admin\\git\\MDR\\MDR\\testData\\IncidentByMonth.Pdf");
	 * 
	 ...
	 * 
	 * extentTest.pass("Successfully added a Expense/Settlement for General Liability Claim");
	 */
