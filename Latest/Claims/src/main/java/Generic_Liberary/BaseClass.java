...
import POM.BasePage;
import POM.EEOCClaim;
import POM.GeneralLiabilityClaim;
import POM.GrcLoginPage;
import POM.HardwareAssetPage;
import POM.HipaaRiskManagementSystemPage;
import POM.HomePage;
import POM.IncidentPage;
import POM.KriDashboardPage;
import POM.MedicalDeviceIncidentPage;
import POM.PhysicalRiskAssessmentPage;
import POM.ProfessionalClaim;
import POM.RMSHomePage;
...
public class BaseClass {
	...
	public IncidentPage incidentPg;
	public MedicalDeviceIncidentPage medicalPg;
	public RMSHomePage rmsPg;
	public EEOCClaim eeocClaim;
	public GeneralLiabilityClaim generalClaim;
	public ProfessionalClaim professionalClaim;
	...
	public void driver(ITestContext context, @Optional("chrome") String bname) {
		...
		incidentPg = new IncidentPage(driver);
		medicalPg=new MedicalDeviceIncidentPage(driver);
		rmsPg = new RMSHomePage(driver);
		eeocClaim = new EEOCClaim(driver);
		generalClaim = new GeneralLiabilityClaim(driver);
		professionalClaim = new ProfessionalClaim(driver);
...
Reporter.log("Place Holder is provided for UserId TextBox in login page",true);
	...
	Reporter.log("Clicked on Login button in login page",true);
		...
		// Verifying Incident Text module and performing click action
		softassert.assertEquals(homePg.getIncidentImage().isDisplayed(), true, "Incident Image is not provided on home page");
		homePg.getIncidentImage().click();
		...
		extentTest.info("Successfully navigated to Incident Management System page");
		Reporter.log("Successfully navigated to Incident Management System page",true);
	...
	public void initialiseExtendReports() throws IOException {
		...
		sparkReporter.config().setReportName("Claims Test Results");
