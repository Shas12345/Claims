...
public class EEOCClaim {
	public EEOCClaim(WebDriver driver) {
	...
	private @FindBy(id = "DateOfIncident") WebElement dateOfIncidentTextbox;
	...
	private @FindBy(xpath = "//label[text()='EEOC #']")WebElement eEOCNumberLabel;
	private @FindBy(id = "EECOCNumber") WebElement eEOCNumberTextbox;
	...
	public WebElement getDateOfIncidentTextbox() {
		return dateOfIncidentTextbox;
	}
	...
	public WebElement geteEOCNumberLabel() {
		return eEOCNumberLabel;
	}
	public WebElement geteEOCNumberTextbox() {
		return eEOCNumberTextbox;
	}
