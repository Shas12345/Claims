...
public class Creating_a_EEOC_Claim extends BaseClass {
	...
	public void submittingaEEOCForm(String info[]) throws InterruptedException {
		...
		softassert.assertEquals(driver.findElement(By.xpath("//label[text()='Litigation Claim #']")).isDisplayed(), true,
				"Litigation Claim # Label is not provided for New EEOC Claim ");
...
//Verifying Title Textbox on Attachment Popup
		...
		softassert.assertEquals(titleTb.isDisplayed(), true, "Title Textbox is not provided for attachment popup for EEOC Claim");
...
//Deleting an added attachment
	...
	//	driver.findElement(By.xpath("(//a[contains(text(),'Attachments')])[3]")).click();
		...
		softassert.assertEquals(deleteButton.isDisplayed(), true, "Delete button is not provided for attachment popup for EEOC Claim");
		 ...
		 * Reporter.log("Attachement removed Successfully for EEOC Claim" +
		 * attachmentInfo, true);
		 * extentTest.pass("Attachement removed Successfully for EEOC Claim" +
		 * attachmentInfo);
		 */
	 ...
	 * extentTest.
	 * pass("Successfully Clicked on Expense/Settlement section under EEOC Claims Details"
	 * );
	 * 
	 ...
	 * extentTest.
	 * pass("Successfully Clicked on Add Expense/Settlement button under EEOC Claims Details"
	 * );
	 * driver.findElement(By.xpath("//button[@onclick='addExpenseSettlement(13);']")
	 * ).click();
	 ...
	 * "Invoice Number Label is not provided for New EEOC Claim "); extentTest.
	 * pass("Successfully verified Invoice Number Label for New EEOC Claim");
	 * 
	 * driver.findElement(By.id("InvoiceNumber")).sendKeys("123N123"); extentTest.
	 * pass("Successfully Entered Invoice Number Text box for New EEOC Claim");
	 * 
	 * //UnderWriter
	 * 
	 ...
	 * pass("Successfully Entered UnderWriter Text box for New EEOC Claim");
	 * 
	 * //Inv.Date
	 * 
	 * WebElement invDate =
	 ...
	 * "Inv.Date Paid Label is not provided for New EEOC Claim "); extentTest.
	 * pass("Successfully verified Inv.Date Paid Label for New EEOC Claim");
	 * 
	 * driver.findElement(By.id("InvPaymentDate")).sendKeys("12/08/2023");
	 * extentTest.
	 * pass("Successfully Entered InvDatePaid Text box for New EEOC Claim");
	 * 
	 ...
	 * ).isDisplayed(), true, "Fees Label is not provided for New EEOC Claim ");
	 ...
	 * ); Reporter.
	 * log("File Choosen button is provided for Add Expense/Settlement popup for EEOC Claim"
	 * , true); extentTest.
	 * pass("File Choosen button is provided for Add Expense/Settlement popup for EEOC Claim"
	 * ); driver.findElement(By.id("file"))
	 * .sendKeys("C:\\Users\\Admin\\git\\MDR\\MDR\\testData\\IncidentByMonth.Pdf");
	 * 
